...
const products = [
  { icon: Shield, title: "Allriskové poistné krytie", desc: "Allriskové poistenie je najkomplexnejšia forma ochrany firemného majetku. Na rozdiel od klasického živelného poistenia kryje všetky riziká, ktoré nie sú výslovne vylúčené.", img: {images.firmy1}, points: ["Ochrana budov, strojov, zásob a technologického vybavenia", "Krytie živelných udalostí: požiar, záplava, víchrica, krupobitie", "Poistenie pre prípad krádeže vlámaním a vandalizmu", "Možnosť rozšírenia o prerušenie prevádzky (ušlý zisk)"] },
  { icon: HandCoins, title: "Poistenie zodpovednosti za škodu", desc: "Chráni firmu pred nárokmi tretích strán pri spôsobení škody na majetku, zdraví alebo finančnej škody.", img: {images.firmy2}, points: ["Všeobecná zodpovednosť za škodu", "Profesijná zodpovednosť", "Zodpovednosť za výrobok", "Krížová zodpovednosť v rámci skupiny"] },
  { icon: Wheat, title: "Agro poistenie", desc: "Špecializované riešenia pre poľnohospodárov — od poistenia úrody po hospodárske zvieratá a techniku.", img: {images.firmy3}, points: ["Poistenie plodín a úrody", "Poistenie hospodárskych zvierat", "Poistenie poľnohospodárskej techniky", "Komplexné krytie agropodnikov"] },
  { icon: BarChart3, title: "Risk Management", desc: "Identifikácia, analýza a manažment rizík vašej firmy — proaktívny prístup k ochrane podnikania.", img: {images.firmy4}, points: ["Audit existujúcich poistných zmlúv", "Identifikácia nepokrytých rizík", "Návrh komplexnej stratégie poistenia", "Pravidelná aktualizácia rizikového profilu"] },
  { icon: Scale, title: "Zodpovednosť a právna ochrana", desc: "Krytie nákladov právneho zastupovania a zodpovednosti štatutárov a manažmentu (D&O).", img: {images.firmy5}, points: ["Poistenie zodpovednosti štatutárov (D&O)", "Právna ochrana firmy a zamestnancov", "Krytie nákladov súdnych konaní", "Ochrana pri pracovnoprávnych sporoch"] },
  { icon: LineChart, title: "Monitoring rizika poistného trhu", desc: "Pravidelné sledovanie zmien na poistnom trhu a optimalizácia vašich zmlúv.", img: {images.firmy6}, points: ["Sledovanie zmien podmienok u poisťovní", "Pravidelná revízia portfólia", "Včasné upozornenie na nové príležitosti", "Optimalizácia ceny a krytia"] },
];
